...
export class InitDatabase1775634343005 implements MigrationInterface {
    name = 'InitDatabase1775634343005'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`messages\` (\`id\` int NOT NULL AUTO_INCREMENT, \`content\` varchar(255) NOT NULL, \`type\` varchar(255) NOT NULL, \`created_at\` int NULL, \`conversation_id\` int NULL, \`sender_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);

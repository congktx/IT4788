...
@Module({
  imports: [
    TypeOrmModule.forFeature([User, RewardProof, RewardAppeal, RewardRule]),
  ],
  controllers: [RewardsController],
  providers: [RewardsService, RewardRulesService],
  exports: [RewardsService, RewardRulesService, TypeOrmModule],
})
